...
| Method | Diagram |
|---|---|
| PCA (dimensionality reduction) | ![pca](pca.jpg) |
| k-NN (vote of nearest points) | ![knn](knn.jpg) |
| Random Forest (trees vote) | ![rf](random_forest.jpg) |
| Logistic Regression (linear + softmax) | ![logreg](logistic_regression.jpg) |
| Neural Net / MLP | ![mlp](mlp.jpg) |
| Autoencoder (unsupervised features) | ![ae](autoencoder.jpg) |
...
- [docs/](.) … READMEs (JP/EN), algorithm diagrams, [make_figures.py](make_figures.py)
